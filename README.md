    ...
    <script>
        const fullQuestionBank = [
            ...
            },
            {
                ...
                correctAnswer: "Mọi sự vật hiện tượng đều được tồn tại trong mối liên hệ với sự vật hiện tượng khác"
            },
            {
                id: 25,
            ...
            {
                id: 32,
                question: "Theo chủ nghĩa duy vật Mác xít, cái chung và cái đơn nhất có thể chuyển hóa lẫn nhau trong quá trình phát triển của sự vật theo cách nào?",
            ...
            },
            {
                ...
                options: ["Điểm giới hạn mà ở đó sự biến đổi về lượng gây ra sự biến đổi về chất", "Điểm giới hạn mà ở đó sự biến đổi không gây ra sự biến đổi về chất", "Điểm giới hạn mà ở đó sự biến đổi gây ra sự biến đổi về lượng", "Điểm giới hạn mà ở đó sự biến đổi không gây ra sự biến đổi về lượng"],
            ...
            },
            {
                ...
                options: ["Là động lực trực tiếp của xã hội có đối kháng giai cấp", "Góp phần cải tạo xã hội, xoá bỏ cái cũ, cái lạc hậu, bảo thủ, tạo cơ sở cho cái mới, cái tiến bộ nảy sinh và phát triển", "Góp phần cải tạo giai cấp cách mạng trở thành giai cấp có đủ năng lực lãnh đạo đối với toàn xã hội", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 135,
            ...
            {
                id: 141,
                question: "Cơ sở để thực hiện đấu tranh giai cấp ở Việt Nam hiện nay là:",
            ...
            },
            {
                id: 158,
                question: "Theo triết học Mác - Lê nin, đâu là đặc trưng của nhà nước vô sản?",
                options: ["Là công cụ thống trị chính trị của giai cấp nông nhân", "Là công cụ thống trị của giai cấp công nhân", "Lần đầu tiên trong lịch sử, một nhà nước mà chức năng chủ yếu của nó không phải là bạo lực trấn áp mà là tổ chức xây dựng, phát triển xã hội mới ra đời", "Tất cả các phương án trên"],
                correctAnswer: "Là công cụ thống trị của giai cấp công nhân"
            },
            {
                id: 159,
                question: "C. Mác cho rằng, chủ thể của xã hội bắt ngồn từ?",
                options: ["Ý niệm tuyệt đối", "Con người", "Con người hiện thực", "Con người thực hiện, nhân dân thực hiện"],
                correctAnswer: "Con người thực hiện, nhân dân thực hiện"
            },
            {
                id: 160,
                question: "Lần đầu tiên Mác trình bày khá toàn diện tư tưởng triết học khoa học về lịch sử trong tác phẩm nào?",
                options: ["Bản thảo kinh tế triết học năm 1844", "Biện chứng của tự nhiên", "Chống Đuyrinh", "Tuyên ngôn của Đảng Cộng sản"],
                correctAnswer: "Bản thảo kinh tế triết học năm 1844"
            },
            {
                id: 161,
                question: "Theo triết học Mác - Lê nin, con người là sản phẩm của:",
                options: ["Quá trình tiến hoá lâu dài của thế giới tinh thần", "Quá trình tiến hoá lâu dài của tự nhiên", "Quá trình tiến hóa lâu dài của xã hội", "Quá trình tiến hóa lâu dài của thế giới vật chất"],
                correctAnswer: "Quá trình tiến hóa lâu dài của thế giới vật chất"
            },
            {
                id: 162,
                question: "Theo triết học Mác - Lê nin, con người có nguồn gốc từ đâu?",
                options: ["Tự nhiên và tinh thần", "Xã hội và tinh thần", "Tự nhiên và xã hội", "Tất cả các phương án trên"],
                correctAnswer: "Tự nhiên và xã hội"
            },
            {
                id: 163,
                question: "Theo triết học Mác - Lê nin, tiền đề tạo điều kiện cần cho sự tồn tại có tính người là:",
                options: ["Mặt xã hội", "Mặt sinh vật", "Mặt sinh vật và mặt xã hội", "Lao động"],
                correctAnswer: "Mặt sinh vật"
            },
            {
                id: 164,
                question: "Theo triết học Mác - Lê nin, quá trình hình thành và phát triển của con người  bị quyết định bởi hệ thống quy luật nào sau đây?",
                options: ["Quy luật tự nhiên", "Quy luật tâm lý, ý thức", "Quy luật xã hội", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 165,
                question: "Theo triết học Mác - Lê nin, bản chất con người thể hiện ở nội dung cơ bản nào?",
                options: ["Điều kiện hình thành bản chất con người", "Phương thức hình thành bản chất con người", "Đặc trưng bản chất con người", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 166,
                question: "Theo chủ nghĩa Mác - Lê nin, để tạo ra con người mang bản chất tốt, cần xây dựng mối quan hệ xã hội như thế nào?",
                options: ["Không có áp bức, bóc lột", "Không có bóc lột, bất công", "Không có áp bức bóc lột bất công", "Không có sự hài hòa"],
                correctAnswer: "Không có áp bức bóc lột bất công"
            },
            {
                id: 167,
                question: "Theo chủ nghĩa Mác - Lê nin, cá nhân là:",
                options: ["Một chỉnh thể đơn nhất vừa mang tính phổ biến, vừa mang tính cá biệt", "Chủ thể của lao động và quan hệ xã hội", "Chủ thể của nhận thức", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 168,
                question: "Theo chủ nghĩa Mác - Lê nin, xã hội là:",
                options: ["Cộng đồng các cá nhân không có quan hệ biện chứng", "Sự thống nhất giữa những cá nhân với nhau", "Cộng đồng người tồn tại độc lập với nhau", "Cộng đồng và các cá nhân có mối quan hệ biện chứng với nhau"],
                correctAnswer: "Cộng đồng và các cá nhân có mối quan hệ biện chứng với nhau"
            },
            {
                id: 169,
                question: "Theo quan điểm của triết học Mác - Lê nin, cộng đồng nhỏ nhất của xã hội là:",
                options: ["Gia đình", "Cơ quan", "Quốc gia", "Nhân loại"],
                correctAnswer: "Gia đình"
            },
            {
                id: 170,
                question: "Theo quan điểm của triết học Mác - Lê nin, cộng đồng lớn nhất của xã hội là:",
                options: ["Gia đình", "Cơ quan", "Quốc gia", "Nhân loại"],
                correctAnswer: "Nhân loại"
            },
            {
                id: 171,
                question: "Theo quan điểm của triết học Mác - Lê nin, cá nhân và xã hội có mối quan hệ như thế nào?",
                options: ["Tách rời nhau", "Quyết định lẫn nhau ", "Độc lập với nhau", "Quan hệ biện chứng"],
                correctAnswer: "Quan hệ biện chứng"
            },
            {
                id: 172,
                question: "Theo quan điểm của triết học Mác - Lê nin, cá nhân được hiểu là:",
                options: ["Chủ thể của các quan hệ xã hội", "Sản phẩm của sự phát triển xã hội", "Vừa là chủ thể của các quan hệ xã hội, vừa là sản phẩm của sự phát triển xã hội", "Tất cả các phương án trên"],
                correctAnswer: "Vừa là chủ thể của các quan hệ xã hội, vừa là sản phẩm của sự phát triển xã hội"
            },
            {
                id: 173,
                question: "C. Mác cho rằng, chủ thể của xã hội không bắt nguồn từ:",
                options: ["Ý niệm hiện thực ", "Con người", "Con người hiện thực", "Con người hiện thực, nhân dân hiện thực"],
                correctAnswer: "Ý niệm hiện thực "
            },
            {
                id: 174,
                question: "Theo triết học Mác - Lê nin, nguồn gốc tự nhiên của con người thể hiện ở:",
                options: ["Con người là kết quả tiến hóa của chính thế giới tự nhiên", "Con người là sản phẩm của quá trình lao động ", "Con người là sản phẩm của tinh thần tuyệt đối", "Con người là sản phẩm của các vị thần tạo ra"],
                correctAnswer: "Con người là kết quả tiến hóa của chính thế giới tự nhiên"
            },
            {
                id: 175,
                question: "Theo triết học Mác - Lê nin, nguồn gốc xã hội hình thành con người là:",
                options: ["Lao động và điều kiện tự nhiên", "Ngôn ngữ và điều kiện tự nhiên", "Lao động và ngôn ngữ", "Tất cả các đáp án trên"],
                correctAnswer: "Lao động và ngôn ngữ"
            },
            {
                id: 176,
                question: "Theo triết học Mác - Lê nin, hệ thống các quy luật nào quy định phương diện sinh học của con người?",
                options: ["Hệ thống các quy luật tự nhiên", "Hệ thông các quy luật tâm lý, ý thức", "Hệ thống các quy luật xã hội", "Tất cả các phương án trên"],
                correctAnswer: "Hệ thống các quy luật tự nhiên"
            },
            {
                id: 177,
                question: "Theo triết học Mác - Lê nin, hệ thống các quy luật nào hình thành và vận động trên nền tảng sinh vật của con người?",
                options: ["Hệ thống các quy luật tự nhiên", "Hệ thống các quy luật tâm lý, ý thức", "Hệ thống các quy luật xã hội", "Tất cả các phương án trên"],
                correctAnswer: "Hệ thống các quy luật tâm lý, ý thức"
            },
            {
                id: 178,
                question: "Theo triết học Mác - Lê nin, hệ thống các quy luật nào quy định quan hệ xã hội giữ người với người?",
                options: ["Hệ thống các quy luật tự nhiên", "Hệ thống các quy luật tâm lý, ý thức", "Hệ thống các quy luật xã hội", "Tất cả các phương án trên"],
                correctAnswer: "Hệ thống các quy luật xã hội"
            },
            {
                id: 179,
                question: "Theo quan điểm của triết học Mác - Lê nin, ý thức xã hội là:",
                options: ["Toàn bộ những tư tưởng, quan điểm, tình cảm, tâm trạng, truyền thống... về chính trị, pháp quyền, đạo đức, tôn giáo, thẩm mỹ và khoa học của một người", "Toàn bộ những tư tưởng, quan điểm, tình cảm, tâm trạng, truyền thống... về chính trị, pháp quyền, đạo đức, tôn giáo, thẩm mỹ và khoa học của một cộng đồng người", "Toàn bộ những tư tưởng, quan điểm, tình cảm, tâm trạng, truyền trống …về chính trị, pháp quyền, đạo đức, tôn giáo, thẩm mỹ và khoa học của một cộng đồng người, phản ánh tồn tại xã hội của họ", "Toàn bộ những tư tưởng, quan điểm, tình cảm, tâm trạng, truyền thống... về chính trị, pháp quyền, đạo đức, tôn giáo, thẩm mỹ và khoa học của một người, phản ánh tồn tại xã hội của họ"],
                correctAnswer: "Toàn bộ những tư tưởng, quan điểm, tình cảm, tâm trạng, truyền trống …về chính trị, pháp quyền, đạo đức, tôn giáo, thẩm mỹ và khoa học của một cộng đồng người, phản ánh tồn tại xã hội của họ"
            },
            {
                id: 180,
                question: "Theo quan điểm của triết học Mác - Lê nin, tồn tại xã hội là:",
                options: ["Đời sống vật chất và điều kiện sinh hoạt vật chất của xã hội", "AĐiều kiện sinh hoạt vật chất của xã hội và quan hệ vật chất", "Quan hệ vật chất và đời sống vật chất", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 181,
                question: "Theo quan điểm của triết học Mác - Lê nin, yếu tố cơ bản nhất của tồn tại xã hội là:",
                options: ["Phương thức sản xuất vật chất", "Dân số", "Mật độ dân số", "Điều kiện tự nhiên - hoàn cảnh địa lý"],
                correctAnswer: "Phương thức sản xuất vật chất"
            },
            {
                id: 182,
                question: "Theo quan điểm của triết học Mác - Lê nin, yếu tố cơ bản cấu thành tồn tại xã hội?",
                options: ["Phương thức sản xuất vật chất", "Dân số và mật độ dân số", "Điều kiện tự nhiên, hoàn cảnh địa lý", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 183,
                question: "Theo quan điểm của triết học Mác - Lê nin, ý thức xã hội có:",
                options: ["Tính giai cấp", "Tính dân tộc", "Tính nhân loại", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 184,
                question: "Theo quan điểm của triết học Mác - Lê nin, căn cứ vào nội dung và lĩnh vực phản ánh ý thức xã hội gồm mấy hình thái ý thức xã hội?",
                options: ["4", "5", "6", "7"],
                correctAnswer: "5"
            },
            {
                id: 185,
                question: "Theo quan điểm của triết học Mác - Lê nin, căn cứ vào trình độ phản ánh ý thức xã hội gồm:",
                options: ["Tâm lý xã hội và ý thức thông thường", "Hệ tư tưởng và ý thức lý luận", "Ý thức thông thường và ý thức lý luận", "Tâm lý xã hội và hệ tư tưởng"],
                correctAnswer: "Ý thức thông thường và ý thức lý luận"
            },
            {
                id: 186,
                question: "Theo quan điểm của triết học Mác - Lê nin, căn cứ vào cấp độ, ý thức xã hội gồm:",
                options: ["Tâm lý xã hội và ý thức thông thường", "Hệ tư tưởng và ý thức lý luận", "Ý thức thông thường và hệ tư tưởng", "Tâm lý xã hội và hệ tư tưởng"],
                correctAnswer: "Tâm lý xã hội và hệ tư tưởng"
            },
            {
                id: 187,
                question: "Theo quan điểm của triết học Mác - Lê nin, so với tồn tại xã hội, ý thức xã hội thường:",
                options: ["Tác động qua lại", "Phản ánh vượt trước", "Lạc hậu hơn", "Lệ thuộc"],
                correctAnswer: "Lạc hậu hơn"
            },
            {
                id: 188,
                question: "Theo quan điểm của triết học Mác - Lê nin, so với tồn tại xã hội, ý thức xã hội có thể:",
                options: ["Tác động qua lại", "Phản ánh vượt trước", "Lạc hậu hơn", "Lệ thuộc"],
                correctAnswer: "Phản ánh vượt trước"
            },
            {
                id: 189,
                question: "Theo quan điểm của triết học Mác - Lê nin, ý thức xã hội có vai trò như thế nào đối với tồn tại xã hội?",
                options: ["Phụ thuộc", "Quyết định", "Quan trọng", "Tác động trở lại"],
                correctAnswer: "Tác động trở lại"
            },
            {
                id: 190,
                question: "Theo quan điểm của triết học Mác - Lê nin, hình thái ý thức xã hội có mối quan hệ như thế nào?",
                options: ["Tác động qua lại với nhau", "Phủ định lẫn nhau", "Một hình thái giữ vai trò quyết định", "Quan hệ biện chứng với nhau trong những điều kiện nhất định hình thái nổi trội hơn và chi phối các hình thái ý thức còn lại"],
                correctAnswer: "Quan hệ biện chứng với nhau trong những điều kiện nhất định hình thái nổi trội hơn và chi phối các hình thái ý thức còn lại"
            },
            {
                id: 191,
                question: "Theo quan điểm của triết học Mác - Lê nin, trong sự phát triển của mình, ý thức xã hội có:",
                options: ["Tính biện chứng", "Tính phát triển", "Tính kế thừa", "Tính khách quan"],
                correctAnswer: "Tính kế thừa"
            },
            {
                id: 192,
                question: "Theo quan điểm của triết học Mác - Lê nin, hình thái ý thức xã hội phản ánh những quan hệ kinh tế , chính trị xã hội, lợi ích giai cấp, địa vị giữa các giai cấp, các dân tộc hay giữa các quốc gia, cũng như thái độ của các giai cấp đối với quyền lực nhà nước trong xã hội?",
                options: ["Ý thức pháp quyền", "Ý thức chính trị ", "Ý thức tôn giáo", "Ý thức đạo đức"],
                correctAnswer: "Ý thức chính trị "
            },
            {
                id: 193,
                question: "Theo triết học Mác - Lê nin, hình thái ý thức xã hội nào là hệ thống quan điểm của một giai cấp về bản chất vai trò của pháp luật?",
                options: ["Ý thức pháp quyền", "Ý thức chính trị ", "Ý thức tôn giáo", "Ý thức đạo đức"],
                correctAnswer: "Ý thức pháp quyền"
            },
            {
                id: 194,
                question: "Theo triết học Mác - Lê nin, hình thái ý thức xã hội nào là toàn bộ những quan niệm, chi thức và các trạng thái xúc cảm tâm lý chung của các cộng đồng người về thiện- ác; lương tâm – trách nhiệm; hạnh phúc, công bằng? ",
                options: ["Ý thức pháp quyền", "Ý thức chính trị ", "Ý thức tôn giáo", "Ý thức đạo đức"],
                correctAnswer: "Ý thức đạo đức"
            },
            {
                id: 195,
                question: "Theo triết học Mác - Lê nin, hình thái ý thức xã hội nào là những tình cảm tâm trạng, quan niệm, tư tưởng, tín điều tôn giáo?",
                options: ["Ý thức pháp quyền", "Ý thức chính trị", "Ý thức tôn giáo", "Ý thức thẩm mỹ"],
                correctAnswer: "Ý thức tôn giáo"
            },
            {
                id: 196,
                question: "Theo triết học Mác - Lê nin, hình thái ý thức xã hội nào là toàn bộ nhũng xúc cảm rung động, thị hiếu quan điểm, lý tưởng phản ánh mối quan hệ thẩm mỹ của con người với đời sống hiện thực khách quan?",
                options: ["Ý thức thẩm mỹ", "Ý thức chính trị", "Ý thức tôn giáo", "Ý thức đạo đức"],
                correctAnswer: "Ý thức thẩm mỹ"
            },
            {
                id: 197,
                question: "Theo triết học Mác - Lê nin, sự lạc hậu của ý thức xã hội so với tồn tại xã hội là do:",
                options: ["Sức ì của tâm lý xã hội, nhất là của thói quen, phong tục, tập quán, truyền thống", "Trong ý thức xã hội có những yếu tố bảo thủ, chẳng hạn như ý thức tôn giáo phản ánh không đúng và không kịp sự vận động, biến đổi của tồn tại xã hội", "Trong xã hội có giai cấp, ý thức xã hội luôn gắn với lợi ích của những nhóm xã hội, tập đoàn xã hội, giai cấp xã hội khác nhau", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 198,
                question: "Theo triết học Mác - Lê nin, mức độ tính chất và hiệu quả của ý thức xã hội đối với tồn tại xã hội phụ thuộc vào những yếu tố nào?",
                options: ["Tính tiến bộ, cách mạng hay lạc hậu, phản động của chủ thể mang ý thức xã hội", "Năng lực triển khai, hiện thực hoá ý thức xã hội vào tổ chức thực tiễn của chủ thể lãnh đạo quản lý", "Mức độ thâm nhập của ý thức xã hội vào quảng đại quần chúng nhân dân", "Tất cả các phương án trên"],
                correctAnswer: "Tất cả các phương án trên"
            },
            {
                id: 199,
                question: "Theo triết học Mác - Lê nin, mức độ, tính chất và hiệu quả tác động của ý thức xã hội đối với tồn tại xã hội phụ thuộc vào yếu tố nào?",
                options: ["Năng lực của chủ thể mang ý thức xã hội", "Năng lực triển khai, hiện thực hóa ý thức xã hội vào tổ chức thực tiễn của chủ thể lãnh đạo quản lý", "Năng lực của quần chúng nhân dân", "Tất cả các phương án trên"],
                correctAnswer: "Năng lực triển khai, hiện thực hóa ý thức xã hội vào tổ chức thực tiễn của chủ thể lãnh đạo quản lý"
            },
            {
                id: 200,
                question: "Theo triết học Mác - Lê nin, mức độ, tính chất và hiệu quả tác động của ý thức xã hội đối với tồn tại xã hội phụ thuộc vào yếu tố nào?",
                options: ["Mức độ thâm nhập của ý thức xã hội vào quảng đại quần chúng nhân dân", "Mức độ hiểu biết của cán bộ lãnh đạo, quản lý", "Mức độ hiểu biết của giai cấp lãnh đạo", "Tất cả các phương án trên"],
                correctAnswer: "Mức độ thâm nhập của ý thức xã hội vào quảng đại quần chúng nhân dân"
            }
        ];
        ...
        const BANNER_CYCLE_SECONDS = 120; // 2 phút
        let timeLeft = QUIZ_DURATION_SECONDS;
        let currentMode = 'binhthuong'; // Chế độ mặc định
        ...
        function selectRandomQuestions(bank, num) {
            ...
            return shuffledBank.slice(0, num);
        }

        // --- Mode Logic ---
        function setMode(mode) {
            currentMode = mode;
            // Xóa tất cả các class mode cũ trên body
            document.body.className = '';
            // Thêm class mode mới
            document.body.classList.add(`mode-${mode}`);
            selectedModeSpan.textContent = getModeName(mode);
            // Ẩn màn hình chọn chế độ, hiện màn hình bắt đầu
        ...
        function getModeName(mode) {
            switch(mode) {
                case 'binhthuong': return 'Bình Thường';
                case 'cudemp': return 'Cú Đêm';
                case 'nutinh': return 'Nữ Tính';
                case 'langman': return 'Lãng Mạn';
                case 'amuot': return 'Ẩm Ướt';
                case 'banggia': return 'Băng Giá';
                case 'ruclua': return 'Rực Lửa';
                case 'biensau': return 'Biển Sâu';
        ...
        function startEffect(effectType) {
            ...
            // Xóa các hiệu ứng cũ trước khi tạo mới
            document.querySelectorAll('.snowflake, .raindrop, .bubble').forEach(el => el.remove());
            
            if (effectType === 'tuyet') {
                effectInterval = setInterval(() => createEffect('snowflake'), 200);
            } else if (effectType === 'mua') {
                effectInterval = setInterval(() => createEffect('raindrop'), 50);
            } else if (effectType === 'bongbong') {
                effectInterval = setInterval(() => createEffect('bubble'), 300);
            }
        }
        ...
        function createEffect(className) {
            ...
            switch(className) {
                case 'snowflake':
                    ...
                    el.style.animationDuration = `${duration}s, ${Math.random() * 3 + 2}s`;
        ...
        function displayQuestion(index) {
            ...
            if (!question) return;
            const currentSelectedOption = document.querySelector(`input[name="question${question.id}"]:checked`);
            if (currentSelectedOption) {
                userAnswers[question.id] = currentSelectedOption.value;
            }
        ...
        function startQuiz() {
            ...
            selectedQuestions = selectRandomQuestions(fullQuestionBank, 50).map(q => {
            ...
            // Bắt đầu hiệu ứng theo chế độ đã chọn
            if (currentMode === 'banggia') {
                startEffect('tuyet');
            } else if (currentMode === 'amuot') {
                startEffect('mua');
            } else if (currentMode === 'biensau') {
                startEffect('bongbong');
            }
        }
        ...
        function submitQuiz() {
            ...
            let correctCount = 0;
            detailedResultsDiv.innerHTML = '<h3>Xem lại đáp án</h3>';
            selectedQuestions.forEach((q, index) => {
                const userAnswer = userAnswers[q.id];
                const isCorrect = userAnswer === q.correctAnswer;
                if (isCorrect) correctCount++;
                let yourAnswerText = userAnswer ? `<span class="your-answer">${userAnswer}</span>` : 'Bạn chưa trả lời';
                detailedResultsDiv.innerHTML += `
                    <div class="question-item">
                        <p><strong>Câu ${index + 1}:</strong> ${q.question}</p>
                        <p>Đáp án của bạn: ${yourAnswerText} ${isCorrect ? '&#10004;' : '&#10008;'}</p>
            ...
            totalQuestionsResultSpan.textContent = selectedQuestions.length;
        ...
        function startBannerCycle() {
            bannerTimer = setInterval(runBannerAnimation, BANNER_CYCLE_SECONDS * 1000);
        }
        function runBannerAnimation() {
            ...
            bannerText.classList.add('running');
            setTimeout(() => {
                bannerContainer.classList.remove('visible');
                bannerText.classList.remove('running');
            }, 15000);
        }
        ...
        function exitApp() {
            alert("Cảm ơn bạn đã tham gia bài thi!");
            clearInterval(quizTimer);
            clearInterval(bannerTimer);
            clearInterval(effectInterval);
            document.querySelectorAll('.snowflake, .raindrop, .bubble').forEach(el => el.remove());
            ...
            quizScreen.style.display = 'none';
            resultsScreen.style.display = 'none';
            document.body.className = ''; // Xóa tất cả các class mode
        }
